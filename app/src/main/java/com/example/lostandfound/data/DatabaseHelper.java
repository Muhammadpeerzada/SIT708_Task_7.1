...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String CREATE_POST_TABLE = String.format("CREATE TABLE %s(%s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT, %s TEXT)", Util.TABLE_NAME, Util.POST_ID, Util.POST_NAME, Util.PHONE_NUMBER, Util.DESCRIPTION, Util.STATE, Util.DATE, Util.LOCATION);
    ...
    public List<Post> getAllPosts() {
        ...
        String[] projection = {Util.POST_ID, Util.POST_NAME, Util.PHONE_NUMBER, Util.DESCRIPTION, Util.STATE, Util.DATE, Util.LOCATION};
    ...
    public Post getPostById(int postId) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            post = new Post(id, name, phoneNumber, description, state, date, location);
        }
